        ...
        <el-col :span="10" :offset=6>
          <el-form :model="consumeForm" :rules="rules" ref="consumeForm"
            ...
            <el-form-item label="商品类别" prop="goodsType">
              <el-select v-model="consumeForm.goodsType" placeholder="商品类别" size="mini">
                <el-option label="食品" value="食品"></el-option>
                <el-option label="电子产品" value="电子产品"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="单价" prop="price">
              <el-input v-model="consumeForm.price" size="mini"></el-input>
            </el-form-item>
            ...
            <el-form-item label="总价" prop="goodsSum">
              <el-input v-model="consumeForm.goodsSum" size="mini"></el-input>
            </el-form-item>
            ...
            <el-form-item label="银行卡类型" prop="bankType">
              <el-select v-model="consumeForm.bankType" placeholder="银行卡类型" size="mini">
                <el-option label="东京三菱UFJ银行" value="东京三菱UFJ银行"></el-option>
                <el-option label="乐天银行" value="乐天银行"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item label="银行卡号" prop="cardNo">
              <el-select v-model="consumeForm.cardNo" placeholder="银行卡号" size="mini">
            ...
            <el-form-item label="货币类型" prop="currency">
              <el-select v-model="consumeForm.currency" placeholder="货币类型" size="mini">

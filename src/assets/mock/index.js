...
Mock.mock('/consume/delete', 'post', simpleResult);
Mock.mock('/sales/register', simpleResult);
Mock.mock('/sales/list', salesSearchResult);
Mock.mock('/sales/delete', 'post', simpleResult);
Mock.mock('/bankcard/list', cardSearchResult);
Mock.mock('/bankcard/delete', 'post', simpleResult);
Mock.mock('/salary/list', salarySearchResult);
Mock.mock('/salary/delete', 'post', simpleResult);
Mock.mock('/accesscard/list', accesscardSearchResult);
Mock.mock('/accesscard/delete', 'post', simpleResult);
Mock.mock('/present/list', presentSearchResult);
Mock.mock('/present/delete', 'post', simpleResult);
Mock.mock('/debt/list', debtSearchResult);
Mock.mock('/debt/delete', 'post', simpleResult);
Mock.mock('/transfer/list', transferSearchResult);
Mock.mock('/transfer/delete', 'post', simpleResult);
...
Mock.mock('/user/register', 'post', simpleResult);
Mock.mock('/user/delete', 'post', simpleResult);
